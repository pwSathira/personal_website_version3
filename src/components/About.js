        ...
        <section id="about"
            ...
            <BlurFade delay={0.2} inView>
                ...
                at York University as a Software Engineering student.`}
                    ...
                    <p className="text-lg max-w-2xl text-center mb-8"> I am passionate about building software solutions
                        and
                        learning new technologies. I am always looking for new opportunities to learn and grow as a
                        developer.
